 ...
 */
class SysApp extends \Comunes\SecurityBundle\Entity\SysApp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\SysApp' . "\0" . 'id', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\SysApp' . "\0" . 'descripcion', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\SysApp' . "\0" . 'nombre', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\SysApp' . "\0" . 'orden', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\SysApp' . "\0" . 'sysSistema');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SysApp $proxy) {
