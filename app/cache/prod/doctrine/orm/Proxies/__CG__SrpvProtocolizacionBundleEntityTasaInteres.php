 ...
 */
class TasaInteres extends \Srpv\ProtocolizacionBundle\Entity\TasaInteres implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'fechaActualzacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'nombre', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'tasaInteres', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'fuenteFinanciamiento', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\TasaInteres' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TasaInteres $proxy) {
    ...
    public function setFechaActualzacion($fechaActualzacion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechaActualzacion', array($fechaActualzacion));

        return parent::setFechaActualzacion($fechaActualzacion);
    }
    ...
    public function getFechaActualzacion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFechaActualzacion', array());

        return parent::getFechaActualzacion();
    }
