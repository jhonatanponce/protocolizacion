 ...
 */
class EstatusDesarrollo extends \Srpv\ProtocolizacionBundle\Entity\EstatusDesarrollo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'descripcion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'estatus', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'fechaActualizacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusDesarrollo' . "\0" . 'nombre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstatusDesarrollo $proxy) {
