 ...
 */
class RegistroPublico extends \Srpv\ProtocolizacionBundle\Entity\RegistroPublico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'fechaActualizacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'nombre', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'geoEstado', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'geoMunicipio', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'geoParroquia', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\RegistroPublico' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistroPublico $proxy) {
