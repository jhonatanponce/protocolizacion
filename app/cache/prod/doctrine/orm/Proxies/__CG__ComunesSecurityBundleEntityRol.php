 ...
 */
class Rol extends \Comunes\SecurityBundle\Entity\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'id', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'descripcion', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'nombre', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'genTipoUsuario', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'sysApp', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Rol' . "\0" . 'sysSistema');
        }
