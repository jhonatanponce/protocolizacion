 ...
 */
class UsuarioHasRol extends \Comunes\SecurityBundle\Entity\UsuarioHasRol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\UsuarioHasRol' . "\0" . 'id', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\UsuarioHasRol' . "\0" . 'fechaAsignacion', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\UsuarioHasRol' . "\0" . 'rol', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\UsuarioHasRol' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioHasRol $proxy) {
