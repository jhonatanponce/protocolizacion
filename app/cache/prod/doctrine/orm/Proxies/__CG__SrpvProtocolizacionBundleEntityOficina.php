 ...
 */
class Oficina extends \Srpv\ProtocolizacionBundle\Entity\Oficina implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'estatus', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'fechaActualizacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'nombre', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'observaciones', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'personaIdJefe', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'geoEstado', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'geoMunicipio', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'geoParroquia', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\Oficina' . "\0" . 'usuario');
        }
    ...
    public function setPersonaIdJefe($personaIdJefe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPersonaIdJefe', array($personaIdJefe));

        return parent::setPersonaIdJefe($personaIdJefe);
    }
    ...
    public function getPersonaIdJefe()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPersonaIdJefe', array());

        return parent::getPersonaIdJefe();
    }
