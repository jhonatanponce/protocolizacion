 ...
 */
class ApoderadoObservador extends \Srpv\ProtocolizacionBundle\Entity\ApoderadoObservador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'apoderado', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'estatus', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'fechaActualizacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'observaciones', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'persona', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'geoEstado', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\ApoderadoObservador' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ApoderadoObservador $proxy) {
    ...
    public function setApoderado($apoderado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setApoderado', array($apoderado));

        return parent::setApoderado($apoderado);
    }
    ...
    public function getApoderado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getApoderado', array());

        return parent::getApoderado();
    }
