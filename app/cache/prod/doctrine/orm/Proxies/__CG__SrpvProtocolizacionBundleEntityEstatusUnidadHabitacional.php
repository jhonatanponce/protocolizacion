 ...
 */
class EstatusUnidadHabitacional extends \Srpv\ProtocolizacionBundle\Entity\EstatusUnidadHabitacional implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'descripcion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'estatus', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'fechaActualizacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\EstatusUnidadHabitacional' . "\0" . 'nombre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstatusUnidadHabitacional $proxy) {
