 ...
 */
class CondicionUnidadFamiliar extends \Srpv\ProtocolizacionBundle\Entity\CondicionUnidadFamiliar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'id', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'estatus', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'fechaCreacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'fechaModificacion', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'nombre', '' . "\0" . 'Srpv\\ProtocolizacionBundle\\Entity\\CondicionUnidadFamiliar' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CondicionUnidadFamiliar $proxy) {
