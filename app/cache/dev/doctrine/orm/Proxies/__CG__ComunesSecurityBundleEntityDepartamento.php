 ...
 */
class Departamento extends \Comunes\SecurityBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Departamento' . "\0" . 'id', '' . "\0" . 'Comunes\\SecurityBundle\\Entity\\Departamento' . "\0" . 'nombre');
        }
