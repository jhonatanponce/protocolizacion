 ...
 * CondicionTrabajo
 *
 * @ORM\Table(name="CONDICION_TRABAJO", indexes={@ORM\Index(name="IDX_62C2607AE8EA1841", columns={"USUARIO_ID"})})
 * @ORM\Entity
 */
class CondicionTrabajo
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="CONDICION_TRABAJO_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
