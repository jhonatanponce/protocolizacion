 ...
 * FuenteIngreso
 *
 * @ORM\Table(name="FUENTE_INGRESO", indexes={@ORM\Index(name="IDX_96D53780E8EA1841", columns={"USUARIO_ID"})})
 * @ORM\Entity
 */
class FuenteIngreso
{
     ...
     * @ORM\SequenceGenerator(sequenceName="FUENTE_INGRESO_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
