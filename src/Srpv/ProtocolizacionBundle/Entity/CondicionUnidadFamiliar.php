 ...
 *
 * @ORM\Table(name="CONDICION_UNIDAD_FAMILIAR", indexes={@ORM\Index(name="IDX_B7787EDBE8EA1841", columns={"USUARIO_ID"})})
 * @ORM\Entity
 */
class CondicionUnidadFamiliar
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="CONDICION_UNIDAD_FAMILIAR_id_s", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @return CondicionUnidadFamiliar
     */
