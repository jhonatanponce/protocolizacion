...
class ViviendaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('precioVivienda', 'integer', array('required' => true))
            ->add('descripcionEstac', 'text', array('label' => 'Descripcion estacionamiento','required' => true))
            ->add('nroEstacionamientos', 'integer', array('required' => true))
            ->add('nroBanos', 'integer', array('required' => true))
            ->add('nroHabitaciones', 'integer', array('required' => true))
