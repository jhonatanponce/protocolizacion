...
class ViviendaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nroPiso')
            ->add('nroVivienda')
            ->add('sala', 'choice', array( 'choices' => array('si' => 'SI','no' => 'No'),'multiple' => false,'expanded' => true,'required' => true))
            ->add('comedor', 'choice', array( 'choices' => array('si' => 'SI','no' => 'No'),'multiple' => false,'expanded' => true,'required' => true))
            ->add('lavandero', 'choice', array( 'choices' => array('si' => 'SI','no' => 'No'),'multiple' => false,'expanded' => true,'required' => true))
