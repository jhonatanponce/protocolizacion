...
class DesarrolloType extends AbstractType
{
    ...
    {
        $builder
            ->add('nombre', 'text', array('label' => 'Nombre','attr' => array('required' => true)))
            ->add('geoEstado', 'entity', array('label' => 'Estado','class'   => 'ComunesTablasBundle:GeoEstado','property'   => 'nombre','attr' => array('required' => true),'empty_value' => ''))
            ->add('geoMunicipio', 'entity', array('label' => 'Municipio','class'   => 'ComunesTablasBundle:GeoMunicipio','property'   => 'nombre','attr' => array('required' => true),'empty_value' => ''))
            ->add('geoParroquia', 'entity', array('label' => 'Parroquia','class'   => 'ComunesTablasBundle:GeoParroquia','property'   => 'nombre','attr' => array('required' => true),'empty_value' => ''))
            ->add('avCallEsqCarr', 'text', array('label' => 'Av/Calle/Esq/Carr','attr' => array('required' => true)))
            ->add('urbanBarrio', 'text', array('label' => 'Urban/Barrio','attr' => array('required' => true)))
            ->add('zona', 'text', array('label' => 'Zona','attr' => array('required' => true)))
