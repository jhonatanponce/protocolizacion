...
use Comunes\TablasBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ComunesTablasBundle:Persona')->findAll();

        return $this->render('ComunesTablasBundle:Persona:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ComunesTablasBundle:Persona:new.html.twig', array(
            'entity' => $entity,
     ...
     */
    private function createCreateForm(Persona $entity, $cedula, $nac)
    {
        $form = $this->createForm(new PersonaType($cedula,$nac), $entity, array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form   = $this->createCreateForm($entity,$request->request->get('form[cedula]', null, true), $request->request->get('form[nacionalidad]', null, true));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ComunesTablasBundle:Persona')->find($id);
        ...
        return $this->render('ComunesTablasBundle:Persona:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ComunesTablasBundle:Persona:edit.html.twig', array(
            'entity'      => $entity,
