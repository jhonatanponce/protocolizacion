...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Por favor arregla el campo.",
		...
		creditcard: "Por favor ingrese un número válido de tarjeta de credito.",
		equalTo: "Por favor ingrese el mismo valor nuevamente.",
		maxlength: $.validator.format( "Por favor no ingrese mas de {0} catacteres." ),
