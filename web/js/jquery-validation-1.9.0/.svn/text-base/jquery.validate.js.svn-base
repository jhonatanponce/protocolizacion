...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Por favor vuelva a ingresar el dato.",
		...
		rangelength: $.validator.format("Por favor ingrese un valor entre {0} and {1} de longitud."),
